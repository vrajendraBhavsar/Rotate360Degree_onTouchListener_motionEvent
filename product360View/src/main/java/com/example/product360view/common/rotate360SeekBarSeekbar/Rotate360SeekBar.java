package com.example.product360view.common.rotate360SeekBarSeekbar;
...
public class Rotate360SeekBar extends View {
    ...
    public Rotate360SeekBar(Context context) {
        super(context);
        init(null, 0);
    }

    public Rotate360SeekBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public Rotate360SeekBar(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void initPaints() {
        ...
        mCirclePaint.setStrokeCap(Paint.Cap.BUTT); //To design end of the arc - round, square, butt - Affect right end
        ...
        mCircleProgressPaint.setStrokeCap(Paint.Cap.BUTT); //To design end of the arc - round, square, butt - Affect left end (If Right one is SQUARE, then that will override Left one too)

        mCircleProgressGlowPaint = new Paint();
        mCircleProgressGlowPaint.set(mCircleProgressPaint);
        mCircleProgressGlowPaint.setMaskFilter(new BlurMaskFilter((5f * DPTOPX_SCALE), BlurMaskFilter.Blur.INNER));
...
//        mPointerHaloBorderPaint.setStrokeWidth(mPointerHaloBorderWidth);
        mPointerHaloBorderPaint.setStrokeWidth(0);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mUserIsMovingPointer) {
            canvas.drawCircle(mPointerPositionXY[0], mPointerPositionXY[1], mPointerRadius + mPointerHaloWidth + (mPointerHaloBorderWidth / 3f), mPointerHaloBorderPaint);
        }
    }
    ...
    public interface OnCircularSeekBarChangeListener {
        ...
        void onProgressChanged(Rotate360SeekBar rotate360SeekBar, int progress, boolean fromUser);

        void onStopTrackingTouch(Rotate360SeekBar seekBar);

        void onStartTrackingTouch(Rotate360SeekBar seekBar);
    }
