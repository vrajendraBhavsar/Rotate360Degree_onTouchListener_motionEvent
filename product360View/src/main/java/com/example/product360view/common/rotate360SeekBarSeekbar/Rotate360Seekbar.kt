...
class Rotate360SeekBar : View {
    ...
    protected fun initPaints() {
        ...
        mCirclePaint!!.strokeJoin = Paint.Join.BEVEL
        mCirclePaint!!.strokeCap =
            Paint.Cap.BUTT //To design end of the arc - round, square, butt - Affect right end
        ...
        mCircleProgressPaint!!.strokeCap =
            Paint.Cap.BUTT //To design end of the arc - round, square, butt - Affect left end (If Right one is SQUARE, then that will override Left one too)
        mCircleProgressGlowPaint = Paint()
        mCircleProgressGlowPaint!!.set(mCircleProgressPaint)
        mCircleProgressGlowPaint!!.maskFilter =
            BlurMaskFilter(5f * DPTOPX_SCALE, BlurMaskFilter.Blur.INNER) // To give glow effect to the process
        mPointerPaint = Paint()
        ...
        mPointerHaloBorderPaint!!.strokeWidth = 0f
